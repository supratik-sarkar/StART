#!/usr/bin/env python3
"""Build Cryptographic Release Freeze Manifest for StART v4.6.1."""
...
def main() -> None:
    ...
    manifest_file = OUTPUT_DIR / "v461_release_manifest.json"
    with open(manifest_file, "w", encoding="utf-8") as f:
        json.dump(
            {
                "release": "StART v4.6.1",
                "timestamp": time.time(),
    ...
    print(f"Generated v4.6.1 release manifest with {len(manifest_entries)} files at: {manifest_file}")

#!/usr/bin/env python3
"""Build Cryptographic Release Freeze Candidate Manifest for StART v5.1.0 (Amendments 47, 49)."""
...
def build_candidate_manifest() -> dict[str, Any]:
    ...
    manifest_data = {
        "release": "StART v5.1.0 Candidate Freeze",
        "version": "5.1.0",
        "timestamp": time.time(),
    ...
    print(f"Generated v5.1.0 candidate manifest with {len(manifest_entries)} files: {manifest_file}")

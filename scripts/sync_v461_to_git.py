#!/usr/bin/env python3
"""Manifest-Driven Synchronizer from Development Tree to Protected Git Tree for v4.6.1."""
...
MANIFEST_PATH = SRC_ROOT / "start_output" / "v461_remote_release" / "v461_release_manifest.json"
...
def main() -> None:
    print("=" * 70)
    print("StART v4.6.1 — Manifest-Driven Protected Git Tree Synchronization")

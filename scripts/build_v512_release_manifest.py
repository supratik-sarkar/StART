#!/usr/bin/env python3
"""Build Cryptographic Release Freeze Candidate Manifest for StART v5.1.2."""
...
def build_candidate_manifest() -> dict[str, Any]:
    ...
    manifest_data = {
        "release": "StART v5.1.2 Candidate Freeze",
        "version": "5.1.2",
        "timestamp": time.time(),
    ...
    manifest_file = OUTPUT_DIR / "v512_candidate_manifest.json"
    with open(manifest_file, "w", encoding="utf-8") as f:
        json.dump(manifest_data, f, indent=2)

    print(f"Generated v5.1.2 candidate manifest with {len(manifest_entries)} files: {manifest_file}")

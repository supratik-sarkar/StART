#!/usr/bin/env python3
"""Manifest-Driven Synchronizer from Development Tree to Protected Git Tree for v5.1.1."""
...
MANIFEST_PATH = SRC_ROOT / "start_output" / "v511_release" / "v511_candidate_manifest.json"
...
def main() -> None:
    print("=" * 70)
    print("StART v5.1.1 — Manifest-Driven Protected Git Tree Synchronization")

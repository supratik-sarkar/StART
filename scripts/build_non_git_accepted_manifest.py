#!/usr/bin/env python3
"""Build Non-Git Accepted Release Manifest for StART v4.5."""
...
def main() -> None:
    ...
    manifest_file = OUTPUT_DIR / "non_git_accepted_release_manifest.json"
    with open(manifest_file, "w", encoding="utf-8") as f:
        json.dump(
            {
                "manifest_type": "NON_GIT_ACCEPTED_RELEASE_MANIFEST",
                "timestamp": time.time(),
                "start_version": "4.5.0",
                "start_schema_version": "4.5.0",
                "frontend_build_version": "4.5.0-prod",
                "non_git_v45_acceptance_verdict": "PASS",
    ...
    print(f"Recorded non-git accepted release manifest with {len(manifest_entries)} files: {manifest_file}")

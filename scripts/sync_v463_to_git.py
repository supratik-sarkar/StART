#!/usr/bin/env python3
"""Manifest-Driven Synchronizer from Development Tree to Protected Git Tree for v4.6.3."""
...
MANIFEST_PATH = SRC_ROOT / "start_output" / "v463_remote_release" / "v463_release_manifest.json"
...
def main() -> None:
    print("=" * 70)
    print("StART v4.6.3 — Manifest-Driven Protected Git Tree Synchronization")
    ...
    if isinstance(files_data, dict):
        items = [{"path": k, "sha256": v} for k, v in files_data.items()]
    else:
        items = files_data

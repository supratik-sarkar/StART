#!/usr/bin/env python3
"""Manifest-Driven Synchronizer from Development Tree to Protected Git Tree for v5.0.0."""
...
MANIFEST_PATH = SRC_ROOT / "start_output" / "v500_release" / "v500_release_manifest.json"
...
def main() -> None:
    print("=" * 70)
    print("StART v5.0.0 — Manifest-Driven Protected Git Tree Synchronization")
    ...
    # Explicit controlled deletion of legacy web/ from Git repository
    legacy_web = DEST_ROOT / "web"
    if legacy_web.exists():
        print(f"Removing legacy web/ directory from destination: {legacy_web}")
        shutil.rmtree(legacy_web)

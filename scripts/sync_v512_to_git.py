#!/usr/bin/env python3
"""Manifest-Driven Synchronizer from Development Tree to Protected Git Tree for v5.1.2."""
...
MANIFEST_PATH = SRC_ROOT / "start_output" / "v512_release" / "v512_candidate_manifest.json"
...
def main() -> None:
    print("=" * 70)
    print("StART v5.1.2 — Manifest-Driven Protected Git Tree Synchronization")

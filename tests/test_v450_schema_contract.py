...
def test_schema_version_consistency() -> None:
    ...
    assert START_SCHEMA_VERSION.startswith(("4.", "5.", "6."))
    assert START_VERSION.startswith(("4.", "5.", "6."))
    info = SystemInfo()
    assert info.start_version.startswith(("4.", "5.", "6."))
    assert info.start_schema_version.startswith(("4.", "5.", "6."))

        ...
        for idx in range(events_len):
            if idx not in sent_indices:
                ...
                payload_data = {
                    ...
                    "sourceAgent": raw_evt.get("source_agent", "Director"),
                    "source_agent": raw_evt.get("source_agent", "Director"),
                    "targetAgent": raw_evt.get("target_agent", "Specialist"),
                    "target_agent": raw_evt.get("target_agent", "Specialist"),
                    "stage": raw_evt.get("stage", "EXECUTION"),
                    "action": raw_evt.get("action", ""),
                    "testId": raw_evt.get("test_id"),
                    "test_id": raw_evt.get("test_id"),
                    "checkpointId": raw_evt.get("checkpoint_id"),
                    "checkpoint_id": raw_evt.get("checkpoint_id"),
